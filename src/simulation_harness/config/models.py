...
class LLMConfig(BaseModel):
    ...
    api_base_env: Optional[str] = Field(None, description="Environment variable for API base URL")
...
class SessionsConfig(BaseModel):
    ...
    max_concurrent_queue_depth: int = Field(8, gt=0, description="Maximum concurrent queue depth")
...
class HarnessConfig(BaseModel):
    ...
    mcp: MCPConfig
    server: ServerSettings = Field(default_factory=ServerSettings, description="Server configuration")
