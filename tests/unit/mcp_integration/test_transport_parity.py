...
@pytest.mark.asyncio
async def test_both_transports_handle_successful_tool_call_identically(mock_simulation_instance):
...
@pytest.mark.asyncio
async def test_both_transports_handle_tool_failure_identically(mock_simulation_instance):
...
@pytest.mark.asyncio
async def test_both_transports_handle_session_expired_identically(mock_simulation_instance):
