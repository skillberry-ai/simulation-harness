...
class TestLLMConfig:
    ...
    def test_rejects_removed_fields(self) -> None:
...
class TestHarnessConfig:
    def test_construct_from_minimal_dict(self) -> None:
...
class TestLoadConfig:
    ...
    def test_legacy_api_key_env_field_rejected(self, tmp_path: Path) -> None:
