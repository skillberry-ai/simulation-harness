...
class TestApplyEnvOverrides:
    def test_no_env_vars_returns_unchanged_config(self, monkeypatch):
    ...
    def test_server_host_override(self, monkeypatch):
        monkeypatch.setenv("HARNESS_SERVER_HOST", "127.0.0.1")
        out = apply_env_overrides(_base())
        assert out.server.host == "127.0.0.1"

    def test_skills_folder_override(self, monkeypatch):
